...
def clear():
    global wazny_h, x_forplot, x1_forplot, y_forplot, y1_forplot, droga_l, listH_xy, listH_xy1, listR_xy, v_xy_l, v_x_l, v_y_l, a_xy_l, a_x_l, a_y_l, droga, i
...
def wyświetlanie_wykresów(orbita, dane):
    global tryb_pracy_silników, m_p, H_startu
    # Tworzenie tekstu-------------------------------------------------------------------------------------------------------
...
# wprowadzanie danych----------------------------------------------------------------------------------------------------
def data_input():
    global test, R_xy, v_x0, v_y0, jak_często, v_x, X_location, Y_location, v_y, m_r, droga, Hnpm, i, x_forplot, x1_forplot, y_forplot, y1_forplot, droga_l, listH_xy, listH_xy1, listR_xy, v_xy_l, v_x_l, v_y_l, a_xy_l, a_x_l, a_y_l, m_p, tryb_pracy_silników, H_startu
    ...
    t0 = font.render("0", True, blackish)
    t1 = font.render("1", True, blackish)
    t2 = font.render("2", True, blackish)
    ...
    while True:
        ...
        v_xBorder = pygame.Rect(100, screen_height * .20,
                                v_xSurface.get_width() + 10, 50)
        screen.blit(v_xSurface, (110, screen_height * .20))

        # v_y
        v_ySurface = font.render(vv_y, True, white)
        v_yBorder = pygame.Rect(100, screen_height - 500,
                                v_ySurface.get_width() + 10, 50)
        screen.blit(v_ySurface, (110, screen_height - 500))

        # m_p
        m_pSurface = font.render(mm_p, True, white)
        m_pBorder = pygame.Rect(100, screen_height - 350,
                                m_pSurface.get_width() + 10, 50)
        screen.blit(m_pSurface, (110, screen_height - 350))

        # H_startu
        H_startuSurface = font.render(HH_startu, True, white)
        H_startuBorder = pygame.Rect(100, screen_height - 200,
                                H_startuSurface.get_width() + 10, 50)
        screen.blit(H_startuSurface, (110, screen_height - 200))

        #praca silnikow
        t_p_sSurface = font.render(t_p_s, True, white)
        t_p_sBorder = pygame.Rect(100, screen_height - 50,
                                     t_p_sSurface.get_width() + 10, 50)
        screen.blit(t_p_sSurface, (110, screen_height - 50))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if H_startuBorder.collidepoint(event.pos):
                    ...
                    H_startuActive = True
                    t_p_sActive = False
                if t_p_sBorder.collidepoint(event.pos):
                    v_xActive = False
                    v_yActive = False
                    m_pActive = False
                    H_startuActive = False
        ...
        if m_pActive:
            ...
            m_pPrompt = font.render("podaj m_p", True, white)
        else:
            pygame.draw.rect(screen, slategrey, m_pBorder, 2)
            m_pPrompt = font.render("podaj m_p", True, slategrey)

        if H_startuActive:
            pygame.draw.rect(screen, white, H_startuBorder, 2)
            H_startuPrompt = font.render("podaj H_startu", True, white)
        else:
            pygame.draw.rect(screen, slategrey, H_startuBorder, 2)
            H_startuPrompt = font.render("podaj H_startu", True, slategrey)



        screen.blit(v_xPrompt, (50, (screen_height * .20) + v_xSurface.get_height()))
        screen.blit(v_yPrompt, (50, (screen_height - 500) + v_ySurface.get_height()))
        screen.blit(m_pPrompt, (50, (screen_height - 350) + m_pSurface.get_height()))
        screen.blit(H_startuPrompt, (50, (screen_height - 200) + H_startuSurface.get_height()))
        ...
        #przyciki wyboru trybu silnika
'''
        t0Buttton = create_button((screen_width / 2) - (t0.get_width() / 2)-400, screen_height * .2,
                                     t0.get_width() + 10, t0.get_height(), lightgrey, slategrey)
        screen.blit(t0, ((screen_width / 2) - (t0.get_width() / 2) - 395, int(screen_height * .2)))

        t1Buttton = create_button((screen_width / 2) - (t1.get_width() / 2)-400, screen_height * .3,
                                     t1.get_width() + 10, t1.get_height(), lightgrey, slategrey)
        screen.blit(t1, ((screen_width / 2) - (t1.get_width() / 2) - 395, int(screen_height * .3)))

        t2Buttton = create_button((screen_width / 2) - (t2.get_width() / 2)-400, screen_height * .4,
                                     t2.get_width() + 10, t2.get_height(), lightgrey, slategrey)
        screen.blit(t2, ((screen_width / 2) - (t2.get_width() / 2) - 395, int(screen_height * .4)))
'''
        if readyButtton:
            if vv_x != "":
                v_x = float(vv_x)
            ...
            if spin == 1:
                ...
                obliczenia_numeryczne(0, 0, H_startu, tryb_pracy_silników)  # Silniki nie zadzaiłały
                ...
                print(m_p, H_startu, tryb_pracy_silników, v_x0, v_y0)
