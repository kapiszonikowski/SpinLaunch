...
def data_input():
    ...
    while True:
        ...
        if readyButtton:
            ...
            test = 0  # niby czemu trzeba tu jeszcze raz edytować !??!!
            ...
            if spin == 1:
                ...
                obliczenia_numeryczne(0, 1, wysokość=H_startu, tryb_pracy_silników=0)  # Silniki nie zadzaiłały
                ...
                if test == 1:
                    ...
                    test = 0
                print('a')
                obliczenia_numeryczne(3, 1, wysokość=H_startu,
